$(function() {
    ...
    function setupCurrentContainer() {
        ...
        $("<div id='"+oldContentId+"' style='overflow: hidden; max-height: " + $(window).height + "; width:" +oldContainerWidth + "px; height:"+oldContainerHeight+"px'></div>").insertBefore("#" + idToUpdate);
